...
//!  En esta version se leen los pines P1.2 y P1.3 sucesivamente
//!
//******************************************************************************
#include "driverlib.h"
#include "Board.h"
...
void main (void)
{
    ...
    SYSCFG2=(ADCPCTL2|ADCPCTL3); // Se habilita el pin 1.2 como entrada analogica
